-- Clean up existing data to prevent primary key errors
...
INSERT INTO Customers VALUES (3, 'Arthur Senior', TO_DATE('1960-01-01', 'YYYY-MM-DD'), 5000, SYSDATE);
...
INSERT INTO Loans VALUES (2, 3, 10000, 5, SYSDATE, ADD_MONTHS(SYSDATE, 60));
